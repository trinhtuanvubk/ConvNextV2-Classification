...
data_val_path = "/home/aittgp/data/faces/CelebA_Spoof/Data/liveness/train"
fake_class_nums = 1
model_title ="convnext_base_in22ft1k"
epoch_scale = 3

parser = argparse.ArgumentParser(description='resnet18 training with PyTorch')
parser.add_argument('--dataroot', metavar='PATH', default='/home/aittgp/data/faces/CelebA_Spoof/Data/liveness/', 
...
parser.add_argument('--img_size', type = int, default = 512, help='the size of image input to the model.')
...
parser.add_argument('-b', '--batch-size', default = 16, type=int, metavar='N', help='mini-batch size (default: 64)')
